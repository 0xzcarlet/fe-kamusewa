...
const SafeDialogPortal = ({ ...props }: DialogPrimitive.DialogPortalProps) => <DialogPrimitive.Portal {...props} />
SafeDialogPortal.displayName = DialogPrimitive.Portal.displayName
...
const SafeDialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col space-y-1.5 text-center sm:text-left", className)} {...props} />
)
SafeDialogHeader.displayName = "SafeDialogHeader"

const SafeDialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
